...
const index = () => {
  ...
  const handlePrint = async (data) => {
    try {
      const response = await axios.post(`/api/birthday_report`, data, {
        headers: {
          "Content-Type": "application/json",
          Authorization: `Bearer ${token}`,
        },
      ...
      link.href = url;
      link.download = `BirthdayReport_${formattedDate}.pdf`; // Use formatted date in the filename
      ...
      <div className="p-5">
        ...
        <div className="px-5 pb-7 dark:bg-background pt-1 w-full bg-white shadow-lg border  rounded-md">
          <div className="w-full py-3 flex justify-start items-center">
            <h2 className="text-lg  font-normal">Birthday Report</h2>
          </div>
          {/* row starts */}
