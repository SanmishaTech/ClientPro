...
const Index = () => {
  ...
  const {
    data: TermPlansData,
    isLoading: isTermPlansDataLoading,
    isError: isTermPlansDataError,
  } = useQuery({
    queryKey: ["term_plans", currentPage, search], // This is the query key
    queryFn: async () => {
      try {
        const response = await axios.get("/api/term_plans", {
          headers: {
    ...
    <>
      <div className="w-full p-5">
        <div className="w-full mb-7 text-right md:pr-6">
          <Button
            onClick={() => navigate("/term_plans/create")}
            variant=""
            ...
            <div className="w-full py-3 flex flex-col gap-2 md:flex-row justify-between items-center">
              ...
              <div className="relative p-0.5 ">
                ...
                <input
                  ...
                  placeholder="Search for Term Plans"
                />
              </div>
              {/* end */}
            </div>
