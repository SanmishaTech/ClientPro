...
class GeneralInsurancesController extends BaseController
{
    ...
    public function update(Request $request, string $id): JsonResponse
    {
        ...
        $generalInsurance->family_member_id = $request->input("family_member_id");
        $generalInsurance->insurance_type = $request->input("insurance_type");
        $generalInsurance->company_name = $request->input("company_name");
        $generalInsurance->premium = $request->input("premium");
        $generalInsurance->start_date = $request->input("start_date");
        $generalInsurance->end_date = $request->input("end_date");
        $generalInsurance->save();
